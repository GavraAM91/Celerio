<x-app-layout>
    ...
    <div class="mt-4">
        <h2>Casier Management</h2>
    </div>
    <div class="mt-4 min-h-screen">
        <div class="card">
            <div class="d-flex justify-content-between align-items-center my-4">
                <div class="d-flex align-items-center gap-3 mx-3">
                    <form class="flex-grow-1" method="GET" action="{{ route('user.indexCasier') }}">
                        <div class="input-group">
                            <span class="input-group-text"><i class="bx bx-search"></i></span>
                            <input type="text" name="search" class="form-control" placeholder="Cari nama casier"
                    ...
                    <div class="flex-grow-1">
                        <div class="btn-group dropdown w-100" id="dropdown-sort">
                            ...
                            <ul class="dropdown-menu w-100">
                                <li><a href="{{ route('user.indexCasier', ['sort' => 'asc']) }}"
                                        class="dropdown-item">Ascending</a></li>
                                <li><a href="{{ route('user.indexCasier', ['sort' => 'desc']) }}"
            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-hover">
                    ...
                    <tbody>
                        @foreach ($data_casier as $casier)
                            <tr>
                                <td>{{ $casier->name }}</td>
                                <td>{{ $casier->email }}</td>
                                <td><span class="badge bg-label-success">Casier</span></td>
                                <td>{{ $casier->created_at->format('d M Y') }}</td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <form action="{{ route('user.destroy', $casier->id) }}" method="POST"
                                                ...
                                                <button type="submit" class="dropdown-item"
                                                    onclick="return confirm('Are you sure you want to delete this casier?')">
