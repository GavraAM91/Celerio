            ...
            <div class="card mb-6">
                ...
                <div class="card-body">
                    <form action="{{ route('product.store') }}" name="createProduct" method="POST"
                        ...
                        <div class="mb-4">
                            <label for="expired_date" class="block text-sm font-medium text-gray-700">Expired
                                Date</label>
                            <input type="datetime-local" id="expired_date" name="expired_date"
                                value="{{ old('expired_date', isset($data) ? \Carbon\Carbon::parse($data->expired_date)->format('Y-m-d\TH:i') : '') }}"
